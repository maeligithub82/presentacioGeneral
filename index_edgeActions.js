...
window.location.href = "portal_educa/indexp.html";
      ...
      Symbol.bindElementAction(compId, symbolName, "${_ldm}", "click", function(sym, e) {
         window.location.href = "LDM/pagldm/index.html";
      ...
      Symbol.bindElementAction(compId, symbolName, "${_taller2}", "click", function(sym, e) {
         window.location.href = "taller-lectura/indexT.html";

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_edubasica_pri}", "click", function(sym, e) {
